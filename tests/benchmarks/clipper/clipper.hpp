...
struct CLIPPER_API MathKernel
{
    ...
    MathKernel(CosFunction fCos, ACosFunction fACos, SinFunction fSin, TanFunction fTan,
               ATan2Function fATan2) :
        cos{fCos},
        acos{fACos}, sin{fSin}, tan{fTan}, atan2{fATan2}
    {
    }
...
void CLIPPER_API SimplifyPolygon(const Path &in_poly, Paths &out_polys,
                                 PolyFillType fillType = pftEvenOdd);
void CLIPPER_API SimplifyPolygons(const Paths &in_polys, Paths &out_polys,
                                  PolyFillType fillType = pftEvenOdd);
...
void CLIPPER_API MinkowskiSum(const Path &pattern, const Path &path, Paths &solution,
                              bool pathIsClosed);
void CLIPPER_API MinkowskiSum(const Path &pattern, const Paths &paths, Paths &solution,
                              bool pathIsClosed);
